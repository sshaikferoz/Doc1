...
export default function CapacityGauges(props) {
  const [commodToPreview, setCommodToPreview] = useState('')
  const [commodClicked, setCommodClicked] = useState('')
  const [subCommodityClicked, setSubCommodityClicked] = useState('')
        ...
        {capacityData.map((item, index) => (
          <div key={index} className={styles.categoryLabel}>
            ...
            <span
              ...
              style={{ color: index < 6 ? COLOR_PALETTE[index] : '#00810a' }}
            >
